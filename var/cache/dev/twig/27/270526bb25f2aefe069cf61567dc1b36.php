...
class __TwigTemplate_22e393b3f6fc08cddb26f11c645c352a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 20, $this->source); })()), "price", [], "any", false, false, false, 20), 'label');
        echo "
\t\t\t";
        // line 21
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "price", [], "any", false, false, false, 21), 'widget');
        echo "
\t\t\t<div class=\"form-error\">
\t\t\t\t";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "price", [], "any", false, false, false, 23), 'errors');
        echo "
\t\t\t</div>
\t\t</div>
\t\t<div class=\"form-group\">
...
";
    ...
    {
        return array (  120 => 30,  114 => 27,  107 => 23,  102 => 21,  98 => 20,  91 => 16,  86 => 14,  82 => 13,  76 => 10,  68 => 4,  58 => 3,  35 => 1,);
    }
...
\t</div>
{% endblock %}
", "pages/ingredient/new.html.twig", "/Users/romaincrispini/Desktop/Symfony/bicarboNat/templates/pages/ingredient/new.html.twig");
    }
}
